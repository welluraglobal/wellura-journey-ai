...
// ✅ Function initialization log
console.log("✅ Function started - places-search edge function initializing");

// Access Google Places API key from environment variables
const GOOGLE_PLACES_API_KEY = Deno.env.get("GOOGLE_PLACES_API_KEY") || "";

// Add more descriptive logging for API key
console.log("Google Places API key configured:", GOOGLE_PLACES_API_KEY ? "Yes (length: " + GOOGLE_PLACES_API_KEY.length + ")" : "No");
console.log("Edge function initialization complete. Ready to handle requests.");
...
serve(async (req) => {
  ...
  try {
    ...
    console.log("✅ Using Google API Key:", GOOGLE_PLACES_API_KEY ? "Present (length: " + GOOGLE_PLACES_API_KEY.length + ")" : "Missing");
